...
var onyxProvider = require("onyx/lib/middleware/onyx");
...
Hub.prototype._createServer = function (router) {
    var app = this;
    app.emit(["log", "debug"], "Starting the Yeti hub.");

    var server = union.createServer({
        before: [
            onyxProvider(new Onyx()),
...
Hub.prototype._createSocketIO = function (server) {
    ...
    var io = socketio.listen(server, socketOptions);
