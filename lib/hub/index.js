...
Hub.prototype._handleTestRequest = function (server, agentId, batchId, path) {
    ...
    // XXX Hack to emulate yogi's echoecho behavior.
    // https://github.com/davglass/echoecho/issues/11
    // Set a value for req.body if it doesn't exist.
    if (!server.req.body) { server.req.body = {}; }
